...
export const Header = () => {
  return (
    <header
      id="home"
      className="flex items-center justify-between xl:justify-around h-full w-full bg-white text-black-100 xl:py-4 xl:px-8 md:py-4 lg:px-18 md:px-10 sm:px-16 py-2 px-8"
    >
      <Logo />
      <MobileMenu />
      <nav>
