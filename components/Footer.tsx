...
export const Footer = () => {
  return (
    <footer className="border-t border-black-10 flex flex-col items-center justify-center w-full bg-white lg:space-y-12 lg:py-16 space-y-6 md:p-8 py-4">
      <nav>
        <ul className="text-paragraph-sm items-center justify-center flex lg:text-heading-6 md:text-paragraph text-black-75 font-regular md:space-x-12 space-x-2">
          <li>
      ...
      <div className="flex items-center justify-center md:flex-row md:space-x-16 space-x-6 text-black-50 ">
        <Link href={socialLinks.github} target="_blank">
          <Image src={github} alt="Brand" className="md:w-10 md:h-10 h-5 w-5" />
        </Link>
      ...
      <div className="flex flex-col items-center space-y-2 px-8">
        ...
        <div className="space-x-1 flex items-center">
          ...
          <span
            role="img"
            className="text-[#FF0000] md:text-lg text-sm"
            aria-label="love"
          >
            ❤️
          </span>
          ...
          <span role="img" className="md:text-lg text-sm" aria-label="laughter">
            😂
          </span>
          <span className="text-black-75 text-paragraph-xs md:text-paragraph-sm">
            by{" "}
